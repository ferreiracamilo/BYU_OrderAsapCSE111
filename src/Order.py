...
class Order:
    ...
    def print_invoice(self):
        ...
        for i in self._requests:
            ...
            one_item = Item(unit=quantity, price=product.get_price(), description=product.get_name(), tax=self._tax_rate)
        ...
        invoice_name = f"invoice-order-{self.get_id}.pdf"
        document.gen(invoice_name, generate_qr_code=True)
        #PDF will be generated by default into parent folder of project, code below will move PDF files to Invoices subfolder
